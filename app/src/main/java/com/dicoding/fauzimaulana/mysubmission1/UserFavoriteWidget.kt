...
import com.dicoding.fauzimaulana.mysubmission1.service.StackWidgetService

class UserFavoriteWidget : AppWidgetProvider() {

    companion object {
        private const val TOAST_ACTION = "com.dicoding.fauzimaulana.TOAST_ACTION"
        const val EXTRA_ITEM = "com.dicoding.fauzimaulana.EXTRA_ITEM"
